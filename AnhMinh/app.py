...
app_ui = ui.page_sidebar(
    ...
    ui.page_navbar(
        ui.nav_panel(
            ...
            ui.div(
                ui.div(id="deck-map-container", style="width: 100%; height: 85vh;"),
...
def server(input, output, session):
    ...
    def deep_dive_panel():
        ...
        return ui.div(
            ...
            ui.output_ui("deep_dive_vn_text"),
    ...
    def deep_dive_vn_text():
        ...
        vn_text = ""
        if 1950 <= year <= 1954:
            vn_text = "First Indochina War / Pre-Geneva Accords."
        elif 1955 <= year <= 1975:
            vn_text = "The Vietnam War period. Demographic impacts include extreme casualties and a baby boom post-1975."
        elif 1976 <= year <= 1985:
            vn_text = "Post-war reunification. Economy struggled under central planning before reforms."
        elif 1986 <= year <= 2000:
            vn_text = "Đổi Mới Economic Reforms (1986 onwards). Marked by rapid economic growth and declining fertility rates."
        else:
            vn_text = "Modern era. Rapid modernization, stable replacement fertility, and rising life expectancy."

        return ui.div(
            ui.span(f"Year {year} Context:", class_="vn-history-year"),
            vn_text,
